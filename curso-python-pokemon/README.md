...
1. **Cloná o descargá** este repositorio:
   ```bash
   git clone <url-del-repo> curso-python-pokemon
   cd curso-python-pokemon
   ```
...
2. 📖 Andá a `semana-01-linux-fundamentos/` y abrí `teoria.md`. Leelo con calma.
3. ✏️ Hacé los ejercicios de `ejercicios.md` en tu propia terminal.
4. 🎮 Jugá el `interactivo.py` de la semana para reforzar.
5. ✅ Si la semana tiene tests, corré `pytest` para autoevaluarte.
6. ➡️ Pasá a la siguiente semana. **No saltees semanas**, cada una usa lo anterior.
7. 🏆 Al final, construí los proyectos de la carpeta `proyectos/`.
